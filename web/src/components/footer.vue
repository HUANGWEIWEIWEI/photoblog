...
<template>
  <div class="footBack">
    <div class="fcontainer">
      ...
      <p>
        托管于
        <a href="https://github.com/HUANGWEIWEIWEI/photoblog" target="_blank">GitHub</a>.
        ...
        运行于<a href="https://cloud.tencent.com/" target="_blank">腾讯云服务器</a> 并由其提供域名解析服务.
      </p>
      <p>
        © Apr,2020
        <a href="https://user.qzone.qq.com/1450549569/infocenter" target="_blank">格调映画</a>. 前端页面由
        <a href="https://cn.vuejs.org/" target="_blank">Vue.js</a> 强力驱动. <a href="/admin" target="_blank">后台管理系统</a>搭建 with
        <a href="https://element.eleme.cn/" target="_blank">Element UI</a>. 
        赣ICP备<a href="http://beian.miit.gov.cn" target="_blank">20002284</a>号-1.
      </p>
      <p>
        <span>Made with </span>VS Code
        <span>by Weiwei Huang.</span>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    runTime: function() {
      //运行倒计时
      var that = this;
      var oldTime = new Date("2020/04/08 00:00:00");
